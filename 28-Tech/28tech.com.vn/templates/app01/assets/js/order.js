		...
		init: function(){
			...
			nhMain.validation.phoneVn();
		  	var validator = self.formElement.validate({
				...
				messages: {
					full_name: {
	                    required: nhMain.getLabel('Vui lòng nhập họ tên'),
	                    minlength: nhMain.getLabel('thong_tin_nhap_qua_ngan'),
	                    maxlength: nhMain.getLabel('thong_tin_nhap_qua_dai')
	                },
	                phone: {
	                	required: nhMain.getLabel('Vui lòng nhập số điện thoại'),
	                ...
	                address: {
	                    required: nhMain.getLabel('Vui lòng nhập địa chỉ'),
	                },
	                city_id: {
	                    required: nhMain.getLabel('Vui lòng chọn tỉnh, thành'),
	                },
	                district_id: {
	                    required: nhMain.getLabel('Vui lòng chọn quận, huyện'),
	                },
	                ward_id: {
	                    required: nhMain.getLabel('Vui lòng chọn phường, xã'),
	                }
	            },
